...
const deny = (reason) => {
  denyDecision(
    [
      ...
      '    mcp__plugin_infra-kit_infra-kit__gh-release-deploy-all         # dev / stage / personal envs',
      '    mcp__plugin_infra-kit_infra-kit__gh-release-deploy-selected    # a subset of services',
      'or the CLI:',
