...
| [core/enforcement.md](./references/core/enforcement.md) | Which layer catches which rule (lint / script / agent-only) with live severities, 6-step violation workflow, Rules 6–7 expanded, WHY for Rules 2–6 | Reviewing a feature, deciding whether CI already covers something | `## Enforcement Layers`, `## Blocking Rules`, `## Adjacent`, `## Rule 6 Expanded`, `## Rule 7 Expanded`, `## Rules 2–6` |
